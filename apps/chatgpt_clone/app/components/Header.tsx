...
export default function Header() {
  return (
    <header className='w-full px-4 sm:px-6 lg:px-8 py-3 border-b border-[#2a2b32] bg-[#262626] flex flex-wrap items-center justify-between gap-4 sm:gap-0'>
      {/* Left: Logo */}
      <div className='flex items-center text-white font-semibold text-lg gap-2'>
        <span>ChatGPT</span>
        <svg
          width='16'
          height='16'
      ...
      {/* Right: Auth + Icons */}
      <div className='order-2 sm:order-3 flex items-center gap-2 sm:gap-3 ml-auto'>
        <SignedIn>
